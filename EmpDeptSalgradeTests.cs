...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var deptNosInChicago = depts
            .Where(d=> d.Loc == "CHICAGO")
            .Select(d => d.DeptNo)
            .ToList();
        
        var result = emps
            .Where(e=>deptNosInChicago.Contains(e.DeptNo))
            .ToList();
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps
            .Join(
                ...
                e => e.DeptNo,   
                d => d.DeptNo,     
                (e, d) => new { EName = e.EName, DName = d.DName } // wynikowy obiekt
            )
            .ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = (
            from e in emps
            join avg in deptAverages on e.DeptNo equals avg.DeptNo
